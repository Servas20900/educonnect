...
const HUB_GRUPO_STORAGE_KEY = 'docente_academico_hub_grupo_id';
  ...
  const cards = [
    {
      id: 'evaluaciones',
      titulo: 'Evaluaciones',
      descripcion: 'Crear y gestionar evaluaciones (actividades, exámenes, tareas)',
      icono: <ClipboardList className="w-16 h-16" />,
      color: 'from-[#185fa5] to-[#0b2545]',
      action: () => navigateTo('/docente/academico/evaluaciones'),
    },
    {
      id: 'calificaciones',
      titulo: 'Calificaciones',
      descripcion: 'Registrar y editar las notas de los estudiantes',
      icono: <BarChart3 className="w-16 h-16" />,
      color: 'from-[#185fa5] to-[#0b2545]',
      action: () => navigateTo('/docente/academico/calificaciones'),
    },
    {
      id: 'promedios',
      titulo: 'Promedios',
      descripcion: 'Ver promedios por semestre y análisis de desempeño',
      icono: <TrendingUp className="w-16 h-16" />,
      color: 'from-[#185fa5] to-[#0b2545]',
      action: () => navigateTo('/docente/academico/promedios'),
    },
  ];
