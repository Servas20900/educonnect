...
# 1. Login
print("=" * 60)
print("VALIDACION: SISTEMA EDUCONNECT DE-HARDCODING")
print("=" * 60)
...
if response.status_code == 200:
    ...
    if bootstrap_response.status_code == 200:
        ...
        print(f"OK Bootstrap endpoint funciona!")
        ...
        print("\n" + "=" * 60)
        print("OK VALIDACION EXITOSA - TODO FUNCIONA")
        print("=" * 60)
    else:
        print(f"ERROR Bootstrap error: {bootstrap_response.status_code}")
